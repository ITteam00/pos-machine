...
import { ItemDictionary } from '../src/PrintReceipt'
...
**********************`
  ...
  describe('Calculate item subtotal', () => {
    it('ITEM000001 totalExpense should be 12', () => {
      ...
      const actualDic:ItemDictionary=calculateExpense(itemDic)
      expect(actualDic['ITEM000001'].totalExpense).toEqual(12)
      expect(actualDic['ITEM000003'].totalExpense).toEqual(37.5)
      expect(actualDic['ITEM000005'].totalExpense).toEqual(9)

    })
  })

  describe('Calculate totalprice and discounted price', () => {
